...
namespace Core.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260504100010_AddShippingProofMediaFileToOrderProductAffiliate")]
    partial class AddShippingProofMediaFileToOrderProductAffiliate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.BookmarkCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.BookmarkCollectionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BookmarkCollectionItems");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.Dispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.FollowRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.MediaFile", b =>
                {
                    ...
                    b.Property<string>("HlsBasePath")
                        .HasColumnType("text");

                    b.Property<bool>("IsActive")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsHlsProcessed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderProductAffiliate", b =>
                {
                    ...
                    b.Property<DateTime?>("ExtensionExpiryDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("ShippingProofMediaFileId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ShippingProofMediaFileId");

                    b.HasIndex("Uid");

                    b.HasIndex("OrderItemStatus", "CountdownExpiryDate")
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductClick", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariantCombination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariantCombinationOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ProductVariantCombinationId", "ProductVariantOptionId")
                        .IsUnique();

                    b.ToTable("ProductVariantCombinationOptions");
                });

            modelBuilder.Entity("Core.Domain.Entities.ProductVariantOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProfileVibe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.SellerSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CommunicationMail")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Story", b =>
                {
                    ...
                    b.Property<int?>("SharedCollectionId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserBagProduct", b =>
                {
                    ...
                    b.Property<string>("ProductVariantCombinationUid")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ProductVariantCombinationUid");

                    b.HasIndex("Uid");

                    b.HasIndex("UserId", "BagProductId")
                        .IsUnique()
                        .HasFilter("\"ProductVariantCombinationUid\" IS NULL");

                    b.HasIndex("UserId", "BagProductId", "ProductVariantCombinationUid")
                        .IsUnique()
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserWishlistProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "WishlistProductId")
                        .IsUnique()
                        .HasFilter("\"ProductVariantCombinationUid\" IS NULL");

                    b.HasIndex("UserId", "WishlistProductId", "ProductVariantCombinationUid")
                        .IsUnique()
                        .HasFilter("\"ProductVariantCombinationUid\" IS NOT NULL");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Vibe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Views.ProfileFollowingView", b =>
                {
                    ...
                    b.ToView("ProfileFollowingView", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.BookmarkCollectionItem", b =>
                {
                    b.HasOne("Core.Domain.Entities.BookmarkCollection", "BookmarkCollection")
                        .WithMany("BookmarkCollectionItems")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Dispute", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.WalletTransaction", "WalletTransaction")
                        .WithMany("Disputes")
            ...
            modelBuilder.Entity("Core.Domain.Entities.NotificationHistory", b =>
                {
                    b.HasOne("Core.Domain.Entities.Profile", "ActorProfile")
                        .WithMany()
                        .HasForeignKey("ActorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.Profile", "ReceiverProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.Order", b =>
                {
                    b.HasOne("Core.Domain.Entities.ShippingDetails", "BillingDetails")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderProductAffiliate", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.ProductVariantCombination", "ProductVariantCombination")
                        .WithMany()
                        .HasForeignKey("ProductVariantCombinationId");

                    b.HasOne("Core.Domain.Entities.MediaFile", "ShippingProofMediaFile")
                        .WithMany()
                        .HasForeignKey("ShippingProofMediaFileId")
                    ...
                    b.Navigation("ShippingProofMediaFile");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariantCombinationOption", b =>
                {
                    b.HasOne("Core.Domain.Entities.ProductVariantCombination", "ProductVariantCombination")
                        .WithMany("CombinationOptions")
                        .HasForeignKey("ProductVariantCombinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.ProductVariantOption", "ProductVariantOption")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariantOption", b =>
                {
                    b.HasOne("Core.Domain.Entities.ProductAttribute", null)
                        .WithMany("ProductVariantOptions")
                        .HasForeignKey("ProductAttributeId");

                    b.HasOne("Core.Domain.Entities.ProductVariant", "ProductVariant")
                        .WithMany("ProductVariantOptions")
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProfileVibe", b =>
                {
                    b.HasOne("Core.Domain.Entities.Profile", "Profile")
                        .WithMany("ProfileVibes")
                        .HasForeignKey("ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Domain.Entities.Vibe", "Vibe")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.ShippingDetails", b =>
                {
                    b.HasOne("Core.Domain.Entities.Country", "CountryNavigation")
                        .WithMany()
                        .HasForeignKey("CountryUid")
                        .HasPrincipalKey("Uid")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Core.Domain.Entities.Story", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.BookmarkCollection", "SharedCollection")
                        .WithMany()
                        .HasForeignKey("SharedCollectionId");

                    b.HasOne("Core.Domain.Entities.Post", "SharedPost")
                        .WithMany()
                        .HasForeignKey("SharedPostId");

                    b.HasOne("Core.Domain.Entities.Product", "SharedProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserBagProduct", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.ProductVariantCombination", "ProductVariantCombination")
                        .WithMany()
                        .HasForeignKey("ProductVariantCombinationUid")
                        .HasPrincipalKey("Uid")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserWishlistProduct", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Product", "WishlistProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Domain.Entities.BookmarkCollection", b =>
                {
                    b.Navigation("BookmarkCollectionItems");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.ProductVariantCombination", b =>
                {
                    b.Navigation("CombinationOptions");
                });
